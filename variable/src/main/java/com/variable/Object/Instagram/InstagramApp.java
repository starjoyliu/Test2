package com.variable.Object.Instagram;
...
import com.variable.Custom.InstagramDialog;
        ...
        new Thread() {
            ...
            public void run() {
                ...
                try {
                    ...
                    Logger.i("Opening Token URL " + url.toString());
        ...
        new Thread() {
            ...
            public void run() {
                ...
                try {
                    ...
                    Logger.d("Opening URL " + url.toString());
                    HttpURLConnection urlConnection = (HttpURLConnection) url
                            .openConnection();
